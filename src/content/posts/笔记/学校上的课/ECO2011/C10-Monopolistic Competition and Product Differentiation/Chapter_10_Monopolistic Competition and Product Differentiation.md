...
市场结构可以按竞争强度从强到弱理解：完全竞争 (Perfect Competition) 位于竞争最强的一端，垄断 (Monopoly) 位于竞争最弱的一端；垄断竞争 (Monopolistic Competition) 和寡头 (Oligopoly) 则处在中间。垄断竞争通常是现实生活中最常见的市场结构，例如餐馆、咖啡店、理发店、服装品牌、加油站、快餐店等。
...
> [!info] 核心定义：产品差异化 (Product Differentiation)
> Product Differentiation 指企业让自己的产品在消费者眼中不同于竞争者产品的过程。差异可以来自产品本身，也可以来自消费者的感知、位置便利性、品牌形象、质量层级或风格类型。
...
| Form of Product Differentiation | 中文解释 | Example |
| --- | --- | --- |
| Differentiation by style or type | 按风格或类型区分 | sedans vs. SUVs |
...
Henry Ford 的早期策略是只提供单一车型和颜色，从而最大化规模经济 (Economies of Scale)，大幅降低汽车生产成本。1913 年移动装配线 (Moving Assembly Line) 让汽车变得更便宜，Ford 一度占据市场优势。但 Alfred P. Sloan 领导的 General Motors (GM) 选择提供多种车型、质量和价格层级。到 1930s，市场给出的答案很清楚：消费者愿意为多样化风格付费。
...
## 3. Monopolistic Competition 的短期均衡 (Short-Run Equilibrium)
...
| ------------------- | --------------------- | --------------------------- |
| Profit              | P > ATC               | 价格高于平均总成本，绿色利润矩形表示正经济利润     |
| Loss                | P < ATC               | 价格低于平均总成本，企业亏损但仍可能通过生产最小化损失 |
| Profit Maximization | MR = MC               | 企业选择使利润最大的产量                |
| Pricing             | Price on Demand Curve | 给定产量后，根据需求曲线确定消费者愿意支付的价格    |

## 4. 长期均衡：零利润均衡 (Zero-Profit Equilibrium)
...
与完全竞争相比，Monopolistic Competition 的长期均衡有两个重要特征。第一，价格高于边际成本，即 P > MC，因此存在 Mark-up。企业愿意在当前价格下多卖一单位，因为该价格高于生产该单位的边际成本；但如果要卖更多，企业必须降低所有单位的价格，所以它不会这样做。第二，企业产量低于使 ATC 最小化的产量，因此存在过剩产能 (Excess Capacity)。
...
| --------------- | ----------------------------- | ----------------------------- |
| Firm Demand     | Perfectly elastic, D = MR = P | Downward-sloping Demand Curve |
| Long-Run Profit | Zero Economic Profit          | Zero Economic Profit          |
| Price and MC    | P = MC                        | P > MC, with Mark-up          |
| Output Level    | Minimum-cost output           | Below minimum-cost output     |
| Capacity        | No excess capacity            | Excess Capacity               |
| Product Variety | Homogeneous product           | Differentiated products       |
...
| --- | --- | --- |
| Highly differentiated consumer goods | 10-20% of revenue | 广告用于强化差异化和品牌忠诚 |
| Industrial products | Little advertising | 买方更专业，信息渠道更直接 |
| Homogenous products | No advertising | 产品无差异，广告难以带来市场力量 |

> [!info] 核心概念：Advertising 与 Price Elasticity of Demand
> 广告若能让消费者更偏好某一企业的产品，就会降低该企业需求的价格弹性 (Price Elasticity of Demand)，使需求曲线更不敏感，企业更容易收取高于边际成本的 Mark-up。若广告提供价格、质量和可得性信息，则可能让需求更有弹性并促进竞争。
...
1963 年，美国一些州开始允许验光师做广告。研究发现，禁止广告的州，一副眼镜平均价格约为 33 美元；不限制广告的州，平均价格约为 26 美元。原因是广告让消费者更容易发现价格更好的替代选择，增强竞争，并使企业面对的需求更有弹性。

| Policy Environment | Average Price Paid for Eyeglasses | Interpretation |
| --- | --- | --- |
...
品牌名称 (Brand Name) 往往伴随大量广告支出和更高价格。批评者认为，Brand Name 为实际上差别不大的产品制造人为差异，使消费者因名人代言或品牌形象支付更高价格。支持者则强调，Brand Name 可以传递质量信息：如果企业愿意花大量资金建立品牌，消费者会推断企业预计长期经营并重视声誉；同时，企业为了保护品牌资产，也有动力维持高质量。
...
| --- | --- | --- |
| Critics | 品牌为实际差异很小的产品创造感知差异 | 可能浪费资源、提高价格、削弱竞争 |
| Defenders | 品牌提供质量信息并约束企业维持质量 | 可能降低消费者搜寻成本、改善选择 |

## 8. 社会福利：Between Perfect Competition and Monopoly
...
| --- | --- | --- |
| Short Run | Markup of price over marginal cost | P > MC 导致部分互利交易无法发生 |
| Short Run | Deadweight loss of monopoly pricing | 类似垄断定价带来的无谓损失 |
| Short Run | Wasteful advertising | 广告若只为制造市场力量，可能浪费资源 |
| Long Run | Too much entry | 进入过多导致固定成本重复 |
| Long Run | Excess capacity | 企业产量低于最小化 ATC 的产量 |
| Offset | Product-variety benefit | 消费者从产品多样性中获得补偿性收益 |

> [!warning] 考点：福利评价不要只看 Excess Capacity
> Monopolistic Competition 的价格和成本表现不如 Perfect Competition，但它提供更丰富的产品选择。考试中若问是否低效率，需要同时写出 P > MC、Excess Capacity、Deadweight Loss，以及 Product-variety benefit 对这些成本的抵消。
...
| Term | 中文对应 | 记忆要点 |
| --- | --- | --- |
| Monopolistic Competition | 垄断竞争 | 多企业、差异化产品、长期自由进入退出 |
| Product Differentiation | 产品差异化 | 企业获得 Market Power 的核心方式 |
| Differentiated Product | 差异化产品 | 消费者认为与其他产品不完全相同 |
| Downward-Sloping Demand Curve | 向下倾斜的需求曲线 | 企业有一定定价能力 |
| Marginal Revenue (MR) | 边际收益 | 垄断竞争企业中 MR < P |
| Marginal Cost (MC) | 边际成本 | 利润最大化条件为 MR = MC |
| Average Total Cost (ATC) | 平均总成本 | 长期零利润均衡中 P = ATC |
| Zero-Profit Equilibrium | 零利润均衡 | 长期进入退出停止，经济利润为零 |
| Mark-up | 加价 | P > MC |
| Excess Capacity | 过剩产能 | 产量低于最小化 ATC 的产量 |
| Advertising | 广告 | 可传递信息，也可强化市场力量 |
